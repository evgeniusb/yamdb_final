    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[reviews.validators.year_validator], verbose_name='Год издания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MaxValueValidator(10, message='Введите число не больше 10'), django.core.validators.MinValueValidator(1, message='Введите число не меньше 1')], verbose_name='Оценка')),
